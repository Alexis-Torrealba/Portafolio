			...
			<div className="flex justify-center flex-wrap gap-2 lg:gap-12 p-5 lg:p-0">
				...
				<div>
					<div
						onClick={() =>
							openModal(
								...
								'./assets/Masterclass_Online_Course_Laptop_Instagram_Post-removebg-preview.png',
					...
					>
						<div className="rounded-t-lg">
							<img
								...
								src="./assets/Captura de pantalla 2024-01-12 133244.png"
								alt=""
							/>
					...
					<div
						onClick={() => {
							openModal(
								...
								'./assets/Masterclass_Online_Course_Laptop_Instagram_Post__1_-removebg-preview.png',
								'https://github.com/Alexis-Torrealba',
					...
					>
						<img
							className="w-full h-52 rounded-t-lg  hover:scale-95 transition duration-500"
							src="./assets/Captura de pantalla 2024-01-12 133709.png"
							alt=""
						/>
						<p className="flex items-center pl-4 bg-[#293548] h-12 rounded-b-lg text-white gap-2 text-xl ">
							<BsEyeFill />
				...
				<div>
					<div
						onClick={() => {
							openModal(
								...
								'./assets/Masterclass_Online_Course_Laptop_Instagram_Post__3_-removebg-preview.png',
								'https://github.com/Alexis-Torrealba/App-To-do',
								'https://to-dojs.netlify.app'
							);
						}}
					...
					>
						<img
							className="w-full h-52 rounded-t-lg hover:scale-95 transition duration-500"
							src="./assets/Captura de pantalla 2024-01-12 135417.png"
							alt=""
						/>
						<p className="flex items-center pl-4 bg-[#293548] h-12 rounded-b-lg text-white gap-2 text-xl ">
							<BsEyeFill />
					...
					<div
						onClick={() => {
							openModal(
								...
								'./assets/Masterclass_Online_Course_Laptop_Instagram_Post__2_-removebg-preview.png',
								'https://github.com/Alexis-Torrealba',
					...
					>
						<img
							className="w-full h-52 rounded-t-lg hover:scale-95 transition duration-500"
							src="./assets/Captura de pantalla 2024-01-12 134517.png"
							alt=""
						/>
						<p className="flex items-center pl-4 bg-[#293548] h-12 rounded-b-lg text-white gap-2 text-xl ">
							<BsEyeFill />
